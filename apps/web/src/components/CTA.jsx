...
const CTA = ({ 
  ...
  description = "Join the innovators who are reshaping the digital landscape. Our expertise meets your ambition to create something extraordinary.",
  primaryAction = {
  ...
  return (
    <section className={`cta-section relative py-32 overflow-hidden ${className}`} id="cta">
          ...
          <div className="cta-content text-center max-w-3xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <Link
                ...
                className="group relative px-8 py-4 bg-gradient-to-r from-blue-600 to-blue-500 rounded-xl text-white font-semibold overflow-hidden transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-blue-500/25"
              >
              ...
              <button 
                ...
                className="group px-8 py-4 rounded-xl text-white font-semibold border border-slate-700 hover:border-slate-500 transition-all duration-300 hover:bg-slate-800/50"
              >
