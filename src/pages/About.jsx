...
import { SiTensorflow, SiMongodb, SiDocker, SiNextdotjs, SiExpress, SiPostgresql, SiCapacitor, SiBun, SiAppwrite, SiSupabase, SiGraphql, SiPrisma, SiTailwindcss, SiTypescript, SiExpo, SiFlutter, SiKotlin, SiSwift, SiFirebase, SiAndroid, SiIos, SiAzure } from 'react-icons/si';
...
const techStacks = [
  ...
  },
  {
    ...
    technologies: [
      ...
      { icon: <SiAzure className="w-12 h-12" />, name: "Azure" }
    ]
  }
];
