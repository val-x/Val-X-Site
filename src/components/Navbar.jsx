      ...
      <nav className="relative flex justify-between items-center px-6 max-w-7xl mx-auto">
        ...
        <div className="hidden md:flex items-center space-x-1">
          ...
          <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
            ...
            >
              <div
                className="absolute inset-0 bg-gradient-to-r from-cyan-500 via-violet-500 to-fuchsia-500 opacity-100 
                group-hover:opacity-90 transition-opacity"
              />
              <div
                className="absolute inset-0 bg-gradient-to-r from-cyan-400 via-violet-400 to-fuchsia-400 opacity-0 
